...
const QUIZ: IQuiz = {
  ...
  conditions: [
    ...
    (arr) => {
      if (arr.includes('134')) return "У родственника было злокачественное новообразование легкого";
      if (arr.includes('135')) return "У родственника было злокачественное новообразование желудка";
      if (arr.includes('136')) return "У родственника было злокачественное новообразование кишечника";
      if (arr.includes('137')) return "У родственника было злокачественное новообразование толстой кишки";
      if (arr.includes('138')) return "У родственника было злокачественное новообразование прямой кишки";
      if (arr.includes('139')) return "У родственника было злокачественное новообразование предстательной железы";
      if (arr.includes('140')) return "У родственника было злокачественное новообразование молочной железы";
      if (arr.includes('141')) return "У родственника было злокачественное новообразование матки";
      if (arr.includes('142')) return "У родственника было злокачественное новообразование опухоли других локализаций";
      if (arr.includes('143')) return "У родственника было злокачественное новообразование полипоз желудка";
      if (arr.includes('144')) return "У родственника было злокачественное новообразование семейный аденоматоз";
      if (arr.includes('145')) return "У родственника было злокачественное новообразование семейный диффузный полипоз толстой кишки";
