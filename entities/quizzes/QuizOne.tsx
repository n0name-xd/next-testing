...
const QUIZ: IQuiz = {
  ...
  conditions: [
    ...
    (arr) => {
      if (arr.includes("36") && arr.includes("36")) { // Ответ ДА» на вопрос 6 или на оба (6 и 7)вопроса. Имеется вероятность стенокардии
    ...
    (arr) => {
      if (arr.includes("40") || arr.includes("42") || arr.includes("44")) { //Ответ «ДА» хотя бы на один вопрос имеется вероятность преходящей ишемической атаки (ТИА) или перенесенного ОНМК
        return "Имеется вероятность преходящей ишемической атаки (ТИА) или перенесенного ОНМК";
      }
      return "";
    },
    (arr) => {
      if (arr.includes("34") && arr.includes("50")) { //Ответ «ДА» на вопрос 13 и на вопрос 5 (отягощенная наследственность по раку легкого) 
    ...
    (arr) => {
      if (arr.includes("56") && arr.includes("52")) { //Ответ «ДА» на вопрос 16 в сочетании с ответом «ДА» на вопрос 14 и/или 15 − вероятность заболеваний верхних отделов желудочнокишечного тракта 
    ...
    (arr) => {
      if (arr.includes("56") && arr.includes("58")) { // Ответ «ДА» на вопрос 16 в сочетании с ответом «ДА» на вопрос 17 и/или 18 − вероятность заболевания нижних отделов ЖКТ
    ...
    (arr) => {
      if (arr.includes("34") && arr.includes("62")) { // Ответ «ДА» на вопрос 19 и на вопрос 5 - отягощенная наследственность по раку легкого
        return "Отягощенная наследственность по раку легкого";
      }
    ...
    (arr) => {
      if (arr.includes("67") && arr.includes("69")) { // Ответ «НЕТ» на вопрос 22 и/или ответ «ДА» на вопрос 23 − фактор риска «нерациональное питание»
